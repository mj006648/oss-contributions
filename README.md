...
|---------|---------|------|--------|------|
| Nessie  | [#10865](https://github.com/projectnessie/nessie/issues/10865) CLI STDOUT redirect 버그 | **후속 PR [#12431](https://github.com/projectnessie/nessie/pull/12431) 제출** (2026-05-23) | 2026-05-14 | `--stdout`/`-S` 옵션 신규, `system(false).streams(...).type("dumb")` 로 stream-backed terminal 강제. 이슈 본문 시나리오 + `:nessie-cli:test`/`:spotlessCheck` 모두 통과. dimas-b 리뷰 대기 |
